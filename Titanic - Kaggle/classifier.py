...
#%matplotlib inline # don't know why it isn't reconized
...
# Review survived rate using 'percentiles=[.61,.62]' knowing our problem description
# mentions 38% survival rate.
...
# SibSb distribution '[.68, .69]'
print(train_df.describe(percentiles=[.68, .69]))
print('_' * 120 + '\n\n')
...
print(train_df[['Pclass', 'Sex','Survived']].groupby(['Pclass', 'Sex'], as_index=False).mean()\
    .sort_values(by='Survived', ascending=False))
print('_' * 120 + '\n\n')
...
# grid = sns.FacetGrid(train_df, col='Pclass', hue='Gernder')
...
print(train_df.loc[:, ['Age*Class', 'Age', 'Pclass']].head(20))
print('_'*120 + '\n\n')
...
sgd = SGDClassifier(max_iter = 500, tol = 0.1)
